...
//
                ...
                if (is_array($data)) {
                    ...
                    foreach ($data as $orderData) {
                        ...
                        if (is_array($orderData)) {
                            ...
                            $orderData['row_hash'] = md5(json_encode($orderData));
    ...
    public function list(Request $request)
    {
        ...
        // Example: Filter orders within a date range
        ...
        $orders = $orders::whereBetween('date', [$dateFrom, $dateTo])
    ...
    public function search(Request $request) {
        ...
        return Orders::where('nm_id', 'like', '%'.$nm_id.'%')->get();
    }
